...
// ../../node_modules/serve-static/node_modules/debug/src/common.js
var require_common = __commonJS({
  "../../node_modules/serve-static/node_modules/debug/src/common.js"(exports2, module2) {
    function setup(env) {
...
// ../../node_modules/serve-static/node_modules/fresh/index.js
var require_fresh = __commonJS({
  "../../node_modules/serve-static/node_modules/fresh/index.js"(exports2, module2) {
    "use strict";
...
var require_utils = __commonJS({
  "../../node_modules/@sap-ux/serve-static-middleware/dist/base/utils.js"(exports2) {
    ...
    var resolveSrcPath = (rootPath, srcPath) => {
      return (0, node_path_1.isAbsolute)(srcPath) ? srcPath : (0, node_path_1.relative)(process.cwd(), (0, node_path_1.join)(rootPath, srcPath));
    };
  ...
  "../../node_modules/@sap-ux/logger/dist/winston-logger/logger.js"(exports2) {
    ...
    var WinstonLogger = class extends BaseWinstonLogger {
      constructor({ logLevel = types_1.LogLevel.Info, transports = [], logPrefix = "main" } = defaultLoggerOptions) {
        ...
        transports.forEach((t2) => this.addToMap(transportMap, t2));
...
var require_extension_logger = __commonJS({
  "../../node_modules/@sap-ux/logger/dist/extension-logger/index.js"(exports2) {
    ...
    var ExtensionLogger = class extends winston_logger_1.WinstonLogger {
       ...
       */
      show() {
        const winstonVSCodeTransport = this._logger.transports.find((t2) => t2 instanceof vscode_output_channel_transport_1.VSCodeTransport);
  ...
  "../../node_modules/@sap-ux/serve-static-middleware/dist/base/servestatic.js"(exports2) {
    ...
    var serveStaticMiddleware2 = (root, config, logger = new logger_1.ToolsLogger()) => {
      ...
      for (const pathConfig of paths) {
        ...
        const fileServer = (0, serve_static_1.default)(srcPath, serveStaticOptions);
...
var regexEscape2 = (str) => str.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var _entityMap = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
...
var i18n_default = {
  ...
  ERROR_UNSUPPORTED_YO_VERSION: "The installed version of `Yo` cli tool: {{installedYoVersion}} is not supported. Please use npm or yarn to globally install the latest supported version by running: 'npm i -g yo@{{latestSupportedYoVer}}'.",
  ERROR_EXECUTING_NPM_LIST_CMD: "Running: {{npmCmd}} returned an error: {{-error}}. Check that npm is installed and available on the path. If `yo@{{latestSupportedYoVer}}` is not installed use npm or yarn to globally install the latest required version by running: 'npm i -g yo@{{latestSupportedYoVer}}'.",
...
module.exports = ({ options, middlewareUtil }) => {
  initI18n();
  const log = new import_logger.ToolsLogger({
  ...
  if (configuration == null ? void 0 : configuration.paths) {
    return (0, import_serve_static_middleware.serveStaticMiddleware)(rootPath, configuration, log);
  } else {
    const message = instance.t("SERVE_STATIC_NO_CONFIG");
    log.error(message);
